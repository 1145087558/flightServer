...
import com.example.flight.entity.ChatMessage;
import com.example.flight.entity.User;
import com.example.flight.util.WebSocketConfig;
...
public class WebSocketController {
	...
	public void onOpen(Session session, EndpointConfig config) {
		...
		ChatMessage chatMessage = new ChatMessage().setFromId(user.getId()).setStatus(user.getStatus())
		...
		System.out.println("登录信息："+chatMessage);
	}
	...
	public void OnMessage(String message) {
		...
		System.out.println("发送信息："+chatMessage);
